...
const langData = {
  es: {
    ...
    "about-p1": "Ingeniero en Sistemas con experiencia en desarrollo de software, aplicaciones móviles y sistemas web. Especializado en la creación de soluciones tecnológicas. Con sólidos conocimientos en backend, frontend y bases de datos relacionales, enfocado en código limpio, escalabilidad y resolución de problemas reales, escalabilidad y resolución de problemas reales",
